...
As noted in the [[RAG (Retrieval Augmented Generation) Overview#Phase 3 Advanced Retrieval|RAG Overview]], query transformations are part of improving signal-to-noise ratio:
...
## See Also
- [[RAG (Retrieval Augmented Generation) Overview#Phase 3 Advanced Retrieval|Advanced Retrieval Phase]] - Where query transformations fit
