...
## Personal Notes
*   **The "Magic" of Workbench**: Being able to run SQL directly in a notebook cell to pull data from BigQuery into a Pandas dataframe is a massive productivity booster.
*   **TPUs**: Vertex AI is the easiest way to access TPUs. Use them for large Transformer training; they are often cheaper per FLOP than GPUs.

## Progress Checklist
- [x] Read overview
- [ ] Understand key concepts (AutoML vs Custom, Workbench)
- [ ] Review technical details (`AIP_MODEL_DIR`)
- [ ] Hands-on practice (Run a custom job or deploy a garden model)
